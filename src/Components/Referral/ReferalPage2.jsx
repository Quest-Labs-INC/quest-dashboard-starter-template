...
const ReferalPage2 = () => {
  ...
  useEffect(() => {
    const getSubmission = async () => {
      let request = generalFunction.createUrl(`api/entities/${appConfig.QUEST_ENTITY_ID}/quests/${appConfig.QUEST_REFERRAL_CAMPAIGN_ID}/submissions?parentEntityId=${appConfig.QUEST_ENTITY_ID}`)
      await axios(request.url, {
        ...
        let filterData = totalData?.filter((ele) => ele.referredBy == localStorage.getItem("questUserId"))
      ...
      <div className="flex-col  my-[30px] ml-[30px] mr-[96px] gap-[24px]">
        <div className="flex-col">
          <div className="flex gap-[12px]">
            <div className="flex flex-col py-[28px] px-[20px] gap-[40px] w-[100%] rounded-[10px]"
              style={{
            ...
            >
              ...
              >
                Invite your friends
                <div className="referral-grey text-[12px] font-[400] leading-[16px] color-[#939393]">
              ...
              <div className="flex gap-[20px]">
                <div className="flex flex-col gap-[12px] w-full">
                  ...
                  <div className="flex flex-col gap-[4px] justify-center w-full">
                    ...
                    <p className="referral-grey text-[12px] font-[500] text-center leading-[16px] w-full color-[#939393]">
        ...
        {!!userData.length ?
        <div className="mt-[16px] rounded-xl overflow-y-auto "
        ...
        >
          <table className="min-w-[1100px] w-full " style={{
            ...
            <thead style={{ background: theme == "dark" ? 'transparent' : '#F0F0F0' }}>
              <tr className="text-sm font-medium font-['Figtree']"
              ...
              {userData?.map((user, index) => (
                ...
                >
                  ...
                  <td className="w-[20%] px-6 py-4  text-center">
                    {new Date(user?.submittedAt).getUTCDate() + "/" + new Date(user?.submittedAt).getUTCMonth() + "/" + new Date(user?.submittedAt).getUTCFullYear()}
                  </td>
