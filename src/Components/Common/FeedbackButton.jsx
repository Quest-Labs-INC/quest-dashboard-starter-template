  ...
  return (
    <div className="z-50">
      ...
      <FeedbackWorkflow
        ...
        contactUrl={`mailto:${
          generalFunction.getDataFromCookies("questUserCredentials")?.email
        }`}
        styleConfig={{
          listHeading: {},
          listHover: {
            background:
              theme == "dark" ? "rgba(162, 162, 162, 0.5)" : "#FBFBFB",
            iconColor: theme == "dark" ? "" : `rgba(${darkerColorString}, 1)`,
            iconBackground: theme == "dark" ? "" : `rgba(${hexToRgb(colorRetriver())}, 0.2)`,
          },
          Form: {
